...
namespace Robot.Common
{
    ...
    public sealed class Map
    {
        ...
        {
            var copy = new List<EnergyStation>();
            foreach (var energyResource in Stations)
            {
                copy.Add(new EnergyStation(){Energy = energyResource.Energy, Position = energyResource.Position.Copy(), RecoveryRate = energyResource.RecoveryRate});
            }
            return copy;
        }
        ...
        public Map(int variant, int initialRobotCount)
        {
            ...
            var mapParams = new Variant(variant);
